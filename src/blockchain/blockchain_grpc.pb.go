...
const (
	TransactionService_CreateTransaction_FullMethodName  = "/blockchain.TransactionService/CreateTransaction"
	TransactionService_CreateTransactions_FullMethodName = "/blockchain.TransactionService/CreateTransactions"
)
...
func (c *transactionServiceClient) CreateTransactions(ctx context.Context, in *CreateTransactionsRequest, opts ...grpc.CallOption) (*CreateTransactionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateTransactionsResponse)
	err := c.cc.Invoke(ctx, TransactionService_CreateTransactions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTransactionServiceServer) CreateTransactions(context.Context, *CreateTransactionsRequest) (*CreateTransactionsResponse, error) {
...
func _TransactionService_CreateTransactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateTransactionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionServiceServer).CreateTransactions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionService_CreateTransactions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).CreateTransactions(ctx, req.(*CreateTransactionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "blockchain.TransactionService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TransactionService_CreateTransactions_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "src/sync/blockchain.proto",
}
